...
namespace pokeInfo
{
    public class WebRequest
    {
        ...
        public static async Task GetPokemonDataAsync(int PokeId, Action<Pokemon.Pokemon> Callback)
        {
            ...
            using (var Client = new HttpClient())
            {
                try
                {
                    ...
                    Pokemon.Pokemon JsonResponse = JsonConvert.DeserializeObject<Pokemon.Pokemon>(StringResponse);
